...
# void GFp_asm_AES_decrypt (const void *inp,void *out,const AES_KEY *key);
$code.=<<___;
.align	16
.globl	GFp_asm_AES_decrypt
.type	GFp_asm_AES_decrypt,\@function,3
.hidden	GFp_asm_AES_decrypt
GFp_asm_AES_decrypt:
	push	%rbx
	push	%rbp
	push	%r12
...
.Ldec_epilogue:
	ret
.size	GFp_asm_AES_decrypt,.-GFp_asm_AES_decrypt
___
#------------------------------------------------------------------#
...
$code.=<<___;
.align	16
.globl GFp_asm_AES_set_decrypt_key
.type  GFp_asm_AES_set_decrypt_key,\@function,3
GFp_asm_AES_set_decrypt_key:
	push	%rbx
	push	%rbp
	push	%r12
	push	%r13
...
.Ldec_key_epilogue:
	ret
.size	GFp_asm_AES_set_decrypt_key,.-GFp_asm_AES_set_decrypt_key
___
...
.align	4
	...
	.rva	.LSEH_begin_GFp_asm_AES_decrypt
	.rva	.LSEH_end_GFp_asm_AES_decrypt
	.rva	.LSEH_info_GFp_asm_AES_decrypt
	...
	.rva	.LSEH_begin_GFp_asm_AES_set_decrypt_key
	.rva	.LSEH_end_GFp_asm_AES_set_decrypt_key
	.rva	.LSEH_info_GFp_asm_AES_set_decrypt_key
...
.LSEH_info_GFp_asm_AES_set_decrypt_key:
	.byte	9,0,0,0
	.rva	key_se_handler
