...
.global GFp_asm_AES_set_decrypt_key
.type   GFp_asm_AES_set_decrypt_key,%function
.align	5
...
@ void GFp_asm_AES_decrypt(const unsigned char *in, unsigned char *out,
@ 		       const AES_KEY *key) {
.global GFp_asm_AES_decrypt
.type   GFp_asm_AES_decrypt,%function
.align	5
GFp_asm_AES_decrypt:
#ifndef	__thumb2__
